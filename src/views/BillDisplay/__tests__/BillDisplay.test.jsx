...
describe("BillDisplay", () => {
  ...
  describe("functions", () => {
    ...
    it("filterDateTime should return correct format", () => {
      ...
      expect(BillDisplay.filterDateTime("05-03-2017 15:25:10 -0400")).toBe(
        "05/03/2017"
      );
      expect(BillDisplay.filterDateTime("15-12-2017 15:25:10 -0400")).toBe(
        "15/12/2017"
      );
      expect(BillDisplay.filterDateTime("11-10-2017 15:25:10 -0400")).toBe(
        "11/10/2017"
      );
      expect(
        BillDisplay.filterDateTime(
    ...
    it("fetchBill should return correct icon", () => {
      ...
      expect(BillDisplay.billIcons("food")).toStrictEqual(
        <FaUtensils color={color} size={24} />
      );
      expect(BillDisplay.billIcons("transport")).toStrictEqual(
        <FaCar color={color} size={24} />
      );
      expect(BillDisplay.billIcons("public-transport")).toStrictEqual(
        <FaBus color={color} size={24} />
      );
      expect(BillDisplay.billIcons("grocery")).toStrictEqual(
        <FaShoppingCart color={color} size={24} />
      );
      expect(BillDisplay.billIcons("shopping")).toStrictEqual(
        <FaShoppingBag color={color} size={24} />
      );
      expect(BillDisplay.billIcons("unknown")).toStrictEqual(
